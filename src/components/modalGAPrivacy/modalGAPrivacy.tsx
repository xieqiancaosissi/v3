    ...
    <>
      <div className={`bottom-ga ${showBottomGA ? "_show" : ""}`}>
        <div className={"sm:flex justify-between gap-6"}>
          <div style={{ maxWidth: 680 }} className={"mb-4 sm:mb-0 text-black"}>
          ...
          <div className={"flex gap-6 items-center"}>
            {buttonNode("")}
            <div className={"bottom-ga-close cursor-pointer text-gray-60"}>
      ...
      >
        <PrivacyContent />
        <div
          className={"flex justify-end mt-6 text-gray-60"}
          style={{ fontSize: 14 }}
        >
          {buttonNode("modal")}
        </div>
...
const PrivacyContent = () => {
  return (
    <div className="text-gray-60 ga-content thinGrayscrollBar">
