        ...
        >
          ...
          <ul className="text-sm list-disc pl-3 mt-5">
            ...
            <li>
              ...
              in donating in the &apos;Show love for voters&apos; section and
          ...
          <ul className="text-sm list-disc pl-3">
            <li>
              ...
              affect the rewards pool or the meme&apos;s position during that
              season.
            </li>
            <li>
            ...
            <li>
              The remaining 3 seats will be reshuffled based on the new
              season&apos;s voting session.
            </li>
          </ul>
        </div>
