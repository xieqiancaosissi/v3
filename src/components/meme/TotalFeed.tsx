...
function TotalFeed({ seed_id }: { seed_id: string }) {
    ...
    return `<div class="flex flex-col gap-2 text-white">
      <div class="flex items-start justify-between gap-4">
        ...
        <div class="flex flex-col items-end gap-0.5">
          <span class="text-xs paceGrotesk-Bold">${feedData?.seedAmount}</span>
      ...
      <div class="flex items-start justify-between gap-4">
        ...
        <div class="flex flex-col items-end gap-0.5">
          <span class="text-xs paceGrotesk-Bold">${feedData?.xrefSeedAmount}</span>
  ...
  return (
    <div className="flex flex-col justify-between gap-0.5 ">
      ...
      >
        <span className="text-xl paceGrotesk-Bold text-white border-b border-dashed border-white relative -top-0.5">
          {feedData?.totalTvl || "-"}
        </span>
