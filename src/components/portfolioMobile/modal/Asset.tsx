  ...
  return (
    <div className="mb-4">
      <div className="bg-gray-20 bg-opacity-70 rounded-md px-4 py-5 w-full mb-0.5">
        ...
        <div className="text-2xl pb-1 flex items-center">
          {total_user_invest_value}
          <div
            className={`flex items-center h-5 text-xs rounded-md px-1 ml-1.5 bg-opacity-20 ${
      ...
      <div className="bg-gray-20 bg-opacity-30   rounded-md px-4 py-3 w-full flex">
        <div className="flex-1">
          ...
          <div className="text-sm pb-1">{getV2PoolUSDValue()}</div>
        ...
        <div className="flex-1">
          ...
          <div className="text-sm pb-1">{getV1PoolUSDValue()}</div>
          <div className="bg-gray-60 bg-opacity-15 rounded py-0.5 px-1 flex items-center text-xs w-fit">
            {percent_in_classic_farms}
            <p
              className="text-xs text-gray-10 ml-1 underline cursor-pointer"
        ...
        <div className="flex-1">
          ...
          <div className="text-sm pb-1">{show_total_xref_value}</div>
        </div>
      </div>
    </div>
  );
