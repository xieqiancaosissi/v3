...
function AssetProfitPage() {
  ...
  return (
    <div className="mb-20">
      ...
      <div className="bg-gray-20 bg-opacity-30 rounded-md p-4 w-full flex">
        <div className="flex-1">
          <div className="flex items-center mb-1">
            <p className="text-gray-50 text-sm mr-1">Pool Fees</p>
            <JumpUpperLeft
          ...
          <div className="text-sm pb-1">{show_total_fees_value}</div>
        </div>
        <div className="flex-1">
          <div className="flex items-center mb-1">
            <p className="text-gray-50 text-sm mr-1">Farm Rewards</p>
            <JumpUpperLeft
              className="cursor-pointer"
              onClick={() => {
